...
var runDataActiveRun = nodecg.Replicant('nextruns');
...
var currentExtra = nodecg.Replicant('nextExtra');
...
function setup(data){
    ...
    for (var i = 0;i<data.teams.length;i++){
        for (var j = 0;j<data.teams[i].players.length;j++){
            ...
            playerName.innerHTML = data.teams[i].players[j].name;
        }
    }
...
const getFontSize = (textLength,baseSize,maxsize) => {
